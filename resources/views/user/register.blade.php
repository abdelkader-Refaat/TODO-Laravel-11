     ...
     <div class="max-w-2xl mx-auto p-4 bg-slate-200 dark:bg-slate-900 rounded-lg ">
         ...
         <form action=" {{route('register.store')}}" method="POST" >
             ...
             <div class="mb-6">
                 ...
                 <input type="email" name="email" id="default-input" placeholder="example@mail.com"
                 class="bg-gray-50  border-gray-300 text-gray-900 text-sm rounded-lg
                  focus:ring-blue-500 border focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400
                  dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                  @error('email')
             ...
             <div class="mb-6">
                 <label for="password-confirm" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Password Confirmation</label>
             ...
             <div class="mb-6 flex justify-center">
                 ...
                 dark:focus:ring-blue-800">Register</button>
